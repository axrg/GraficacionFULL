...
var
  vertices = [
    (x: 0.0, y: 1.0, z: 0.0),   # Vértice superior
    (x: -1.0, y: -1.0, z: -1.0), # Vértice inferior izquierdo trasero
    (x: 1.0, y: -1.0, z: -1.0),  # Vértice inferior derecho trasero
    (x: 1.0, y: -1.0, z: 1.0),   # Vértice inferior derecho frontal
    (x: -1.0, y: -1.0, z: 1.0)   # Vértice inferior izquierdo frontal
  ]
  
  edges = [
    (0, 1), (0, 2), (0, 3), (0, 4), # Aristas de la punta a cada vértice de la base
